...
// List<int> floatBytes = Float32List(1)..[0] = d.toFloat().buffer.asUint8List();
  ...
  Future<void> initPlatformState() async {
    ...
    try {
      ...
      isMockLocationEnabled = await SecurityInfo.isMockLocationEnabled() ?? false;
    ...
    isStringSaved= await SecurityInfo.saveString("summy", "674534", "abort","jvjdjkvhbdj" ) ?? false;
    isBoolSaved= await SecurityInfo.saveBoolean("summy", "674534", "abortBoolean", false)?? false;
   isIntSaved=  await SecurityInfo.saveInteger("summy", "674534", "abortInt", 9876)?? false;
  //  isFloatSaved=  await SecurityInfo.saveDouble("summy", "674534", "abortFloat", 89.08) ?? false;
  getString =await SecurityInfo.getString("summy", "674534", "abort") ?? "";
