...
Java_com_kumpali_security_1info_Native_isMagiskPresentNative(JNIEnv *env, jclass clazz) {
    bool bRet = false;
    do {
...
JNIEXPORT jboolean JNICALL
Java_com_kumpali_security_1info_Native_AntiFridaNativeLoader_1checkFridaByPort(JNIEnv *env,
                                                                                  jclass clazz) {
